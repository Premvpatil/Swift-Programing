 ...
 */
func checkAge(_ ageInput: String) {
...
checkAge(userInputAge)        // Invalid input

checkAge("21")                // Valid input
print()
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
func checkAge1(_ ageInput: String) -> Int? {
    if let age = Int(ageInput) {
        if age > 18 {
            print("Welcome!")
        } else {
...
let userInputAge1: String = "34e"
if let returnedAge = checkAge1(userInputAge1) {
    print(returnedAge)
} else {
    print("No valid age returned.")
}

if let returnedAge2 = checkAge1("25") {
    print(returnedAge2)
} else {
    print("No valid age returned.")
}
...
if let cost = costOfItem("Chips") {
    print(cost)
} else {
    print("Item is out of stock or does not exist.")
}
