...
print(positiveArea)  // Should print Optional(50.0)

let negativeArea = calculateArea(x: -5, y: 10)
print(negativeArea)  // Should print nil
...
// Call with non-nil parameters
let result1 = add(3, 5)   // result1 will be 8

// Call with at least one nil parameter
let result2 = add(nil, 7) // result2 will be nil
