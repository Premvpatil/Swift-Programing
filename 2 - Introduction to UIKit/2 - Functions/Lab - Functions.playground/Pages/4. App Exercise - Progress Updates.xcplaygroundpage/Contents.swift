...
progressUpdate(steps: 5, goal: 50)
progressUpdate(steps: 20, goal: 50)
progressUpdate(steps: 45, goal: 50)
progressUpdate(steps: 49, goal: 50)
progressUpdate(steps: 55, goal: 50)
...
pacing(currentDistance: 5.0, totalDistance: 10.0, currentTime: 30.0, goalTime: 50.0)  
