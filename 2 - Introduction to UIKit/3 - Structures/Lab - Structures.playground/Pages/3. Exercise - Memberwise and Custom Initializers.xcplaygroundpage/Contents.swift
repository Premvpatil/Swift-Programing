...
var myLocation = GPS(latitude: 51.5074, longitude: -0.1278)
...
let favoriteBook = Book(title: "The Catcher in the Rye", author: "J.D. Salinger", pages: 277, price: 9.99)
...
let laptop2 = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2022)

print("Laptop 1 - Screen Size: \(laptop1.screenSize) inches, Repairs: \(laptop1.repairCount), Year Purchased: \(laptop1.yearPurchased)")
print("Laptop 2 - Screen Size: \(laptop2.screenSize) inches, Repairs: \(laptop2.repairCount), Year Purchased: \(laptop2.yearPurchased)")
print("\n")
/*:
