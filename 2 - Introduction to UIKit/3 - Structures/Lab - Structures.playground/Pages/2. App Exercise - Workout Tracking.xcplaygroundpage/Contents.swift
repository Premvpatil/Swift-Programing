...
var myWorkout = RunningWorkout()

print("Distance: \(myWorkout.distance) km, Time: \(myWorkout.time) minutes, Elevation: \(myWorkout.elevation) meters")
...
print("First Run - Distance: \(firstRun.distance) km, Time: \(firstRun.time) minutes, Elevation: \(firstRun.elevation) meters")
...
print("During the run, you covered a distance of \(firstRun.distance) meters in \(firstRun.time) minutes, with an elevation gain of \(firstRun.elevation) meters.")
