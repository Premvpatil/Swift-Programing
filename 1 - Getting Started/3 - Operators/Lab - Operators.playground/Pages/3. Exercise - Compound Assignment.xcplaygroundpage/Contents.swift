 ...
 */
var piggiBank = 0.0
print("Initial Piggy Bank Balance: \(piggiBank)")
piggiBank += 10
print("Balnce after moving laen : $\(piggiBank)")
piggiBank += 20
print("Balance after odd jobs : $\(piggiBank)")
piggiBank /= 2
print("Balance ter movie and dinner : $\(piggiBank)")
piggiBank *= 3
print("balance after washing windows : $\(piggiBank)")
piggiBank -= 3
print("Balance after convenience store : $\(piggiBank)")
