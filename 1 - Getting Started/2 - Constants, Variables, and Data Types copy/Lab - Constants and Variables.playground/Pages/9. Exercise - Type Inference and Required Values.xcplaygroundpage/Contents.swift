...
//var name: String
//print(name)
print("Type Inference and Required Values.xcplaygroundpage:6:5: note: 'name' previously declared here var name:String")
//:  Now assign a value to `name`, and print it to the console.
var name: String = "Prem Patil"
print(name)

//:  Declare a variable called `distanceTraveled` and set it to 0. Do not give it an explicit type.
//var distanceTraveled = 0
var distanceTraveled : Float = 0
// or var distanceTraveled : Double = 0
...
print("Type Inference and Required Values.xcplaygroundpage:17:20: error: cannot assign value of type 'Double' to type 'Int' distanceTraveled = 54.3 ")
